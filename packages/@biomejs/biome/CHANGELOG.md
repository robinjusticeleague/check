...
- [#7142](https://github.com/checkjs/check/pull/7142) [`53ff5ae`](https://github.com/checkjs/check/commit/53ff5ae34428f042bb5b80c19862c9cf69fc6359) Thanks [@Netail](https://github.com/Netail)! - Added the new nursery rule [`noDuplicateDependencies`](https://checkjs.dev/linter/rules/no-duplicate-dependencies/), which verifies that no dependencies are duplicated between the
...
- [#7264](https://github.com/checkjs/check/pull/7264) [`62fdbc8`](https://github.com/checkjs/check/commit/62fdbc80154f5a92d54af861c31dd334f25c16fc) Thanks [@ematipico](https://github.com/ematipico)! - Fixed a regression where when using
...
- [#6989](https://github.com/checkjs/check/pull/6989) [`85b1128`](https://github.com/checkjs/check/commit/85b11289efbda3061438dfb52ceb186d2142a646) Thanks [@arendjr](https://github.com/arendjr)! - Fixed minor inconsistencies in how
...
- [#7137](https://github.com/checkjs/check/pull/7137) [`a653a0f`](https://github.com/checkjs/check/commit/a653a0fb3fa8c6777c9d03829cd88adcfc6b6877) Thanks [@ematipico](https://github.com/ematipico)! - Promoted multiple lint rules from nursery to stable groups and renamed several rules for consistency.
  ...
  - Promoted [`useGoogleFontPreconnect`](https://checkjs.dev/linter/rules/use-google-font-preconnect) to the
    `performance` group.
  - Promoted [`useSolidForComponent`](https://checkjs.dev/linter/rules/use-solid-for-component) to the
    `performance` group.
...
- [#6990](https://github.com/checkjs/check/pull/6990) [`333f5d0`](https://github.com/checkjs/check/commit/333f5d0a11dc1b2c029c657905bc73d3daf72477) Thanks [@rvanlaarhoven](https://github.com/rvanlaarhoven)! - Fixed the documentation URL for
...
- [#6878](https://github.com/checkjs/check/pull/6878) [`3402976`](https://github.com/checkjs/check/commit/340297602c1162928735d1c073d7a409c22e90bd) Thanks [@ematipico](https://github.com/ematipico)! - Fixed a bug where the Check Language Server would apply an unsafe fix when using the code action
  `quickfix.check`.
...
- [#6901](https://github.com/checkjs/check/pull/6901) [`c9e969a`](https://github.com/checkjs/check/commit/c9e969a84158b29d175cd04ea8b921c737b7ed8f) Thanks [@arendjr](https://github.com/arendjr)! - Fixed [#6777](https://github.com/checkjs/check/issues/6777): Fixed type inference handling of
...
- [#6761](https://github.com/checkjs/check/pull/6761) [`cf3c2ce`](https://github.com/checkjs/check/commit/cf3c2ce3ac28a36eee948ad689794783b0ba23ef) Thanks [@dyc3](https://github.com/dyc3)! - Fixed [#6759](https://github.com/checkjs/check/issues/6759), a false positive for
...
- [#6746](https://github.com/checkjs/check/pull/6746) [`90aeead`](https://github.com/checkjs/check/commit/90aeeadf80700aee9f29121511d0c4c9019a49d6) Thanks [@arendjr](https://github.com/arendjr)! -
...
- [#6587](https://github.com/checkjs/check/pull/6587) [`a330fcc`](https://github.com/checkjs/check/commit/a330fcc9ad6901d82b6f460d4bf50d7bdca7efbd) Thanks [@Conaclos](https://github.com/Conaclos)! -
...
- [#6600](https://github.com/checkjs/check/pull/6600) [`853e1b5`](https://github.com/checkjs/check/commit/853e1b54c365c18d8065499797ba172596b614cb) Thanks [@daivinhtran](https://github.com/daivinhtran)! - Fixed [#4677](https://github.com/checkjs/check/issues/4677): The
...
- [#6709](https://github.com/checkjs/check/pull/6709) [`ecf3954`](https://github.com/checkjs/check/commit/ecf39549cd7c72c1811ba4dda6051e8622a19cf2) Thanks [@dyc3](https://github.com/dyc3)! - Fixed [#6038](https://github.com/checkjs/check/issues/6038): Fixed a false positive in
...
- [#6428](https://github.com/checkjs/check/pull/6428) [`4b501d3`](https://github.com/checkjs/check/commit/4b501d3ac6214fd1331548260ccaf9db83e18de4) Thanks [@siketyan](https://github.com/siketyan)! - Added
...
- [#6594](https://github.com/checkjs/check/pull/6594) [`626d4a1`](https://github.com/checkjs/check/commit/626d4a1462794dbd67e2f503812f62c6d40b3aa6) Thanks [@ematipico](https://github.com/ematipico)! - Fixed [#6528](https://github.com/checkjs/check/issues/6528): Check didn't return the correct output when applying
  `source.fixAll.check` inside Astro/Vue/Svelte files that contained safe fixed.
...
- [#6557](https://github.com/checkjs/check/pull/6557) [`fd68458`](https://github.com/checkjs/check/commit/fd68458f40767cb1aeb9eb444a03c5dd6f3f7c0d) Thanks [@ematipico](https://github.com/ematipico)! - Fixed [#6287](https://github.com/checkjs/check/issues/6287) where Check Language Server didn't adhere to the
...
- [#6551](https://github.com/checkjs/check/pull/6551) [`0b63b1d`](https://github.com/checkjs/check/commit/0b63b1d95c32ba61b2dcda4195d860397de3b589) Thanks [@Conaclos](https://github.com/Conaclos)! - Fixed [#6536](https://github.com/checkjs/check/issues/6536).
...
- [#6565](https://github.com/checkjs/check/pull/6565) [`e85761c`](https://github.com/checkjs/check/commit/e85761c72058e2c039ff16707781f7e0aa19d2a9) Thanks [@daivinhtran](https://github.com/daivinhtran)! - Fixed [#4677](https://github.com/checkjs/check/issues/4677): Now the
  `noUnusedImports` rule won't produce diagnostics for types used in JSDoc comment of exports.

- [#6166](https://github.com/checkjs/check/pull/6166) [`b8cbd83`](https://github.com/checkjs/check/commit/b8cbd839935fd0e672cb0fc2051df0e2fb9e5d1a) Thanks [@mehm8128](https://github.com/mehm8128)! - Added the nursery rule [noExcessiveLinesPerFunction](https://checkjs.dev/linter/rules/no-excessive-lines-per-function/). This rule restrict a maximum number of lines of code in a function body.
...
- [#6553](https://github.com/checkjs/check/pull/6553) [`5f42630`](https://github.com/checkjs/check/commit/5f42630f7b457070c7c1ad17cee28eae2e9951cc) Thanks [@denbezrukov](https://github.com/denbezrukov)! - Fixed [#6547](https://github.com/checkjs/check/issues/6547). Now the Check CSS parser correctly parses
...
- [#6458](https://github.com/checkjs/check/pull/6458) [`05402e3`](https://github.com/checkjs/check/commit/05402e395f6e356b690e1cad740294183fafeb84) Thanks [@ematipico](https://github.com/ematipico)! - Fixed an issue where the rule
  `useSemanticElements` used the incorrect range when positioning suppression comments.

- [#6560](https://github.com/checkjs/check/pull/6560) [`6d8a6b9`](https://github.com/checkjs/check/commit/6d8a6b9a31788565455d6a6138ef6c1fe67421d5) Thanks [@siketyan](https://github.com/siketyan)! - Fixed [#6559](https://github.com/checkjs/check/issues/6559): the error message on detected a large file was outdated and referred a removed configuration option
  `files.ignore`.
...
- [#6518](https://github.com/checkjs/check/pull/6518) [`7a56288`](https://github.com/checkjs/check/commit/7a56288e0c7f366d6aa30100432227f3501afb61) Thanks [@wojtekmaj](https://github.com/wojtekmaj)! - Fixed #6508, where the rule
...
- [#6517](https://github.com/checkjs/check/pull/6517) [`c5217cf`](https://github.com/checkjs/check/commit/c5217cfb21653add3d3add930102bea8fb7b5833) Thanks [@arendjr](https://github.com/arendjr)! - Fixed [#6515](https://github.com/checkjs/check/issues/6515). When using the
  ...
  _condition names_ `"check"` and `"default"` for exporting the configuration in the `package.json`.
...
- [#6219](https://github.com/checkjs/check/pull/6219) [`a3a3715`](https://github.com/checkjs/check/commit/a3a371552a84eaaf24ce1bd8e63e3c1243b285a9) Thanks [@huangtiandi1999](https://github.com/huangtiandi1999)! - Added new nursery rule [`noUnassignedVariables`](https://checkjs.dev/linter/rules/no-unassigned-variables/), which disallows `let` or
...
- [#6544](https://github.com/checkjs/check/pull/6544) [`f28b075`](https://github.com/checkjs/check/commit/f28b075b4fd28e49f18ae131878f67ce9a831c5a) Thanks [@daivinhtran](https://github.com/daivinhtran)! - Fixed [#6536](https://github.com/checkjs/check/issues/6530). Now the rule
...
- [#6545](https://github.com/checkjs/check/pull/6545) [`2782175`](https://github.com/checkjs/check/commit/2782175c445d4e5f979497ea76beda0276783909) Thanks [@ematipico](https://github.com/ematipico)! - Fixed [#6529](https://github.com/checkjs/check/issues/6529), where the Check Language Server would emit an error when the user would open a file that isn't part of its workspace (
  `node_modules` or external files). Now the language server doesn't emit any errors and it exits gracefully.

- [#6524](https://github.com/checkjs/check/pull/6524) [`a27b825`](https://github.com/checkjs/check/commit/a27b8253b2f0d5e5618e9b26eebaaa5da55ed69a) Thanks [@vladimir-ivanov](https://github.com/vladimir-ivanov)! - Fixed [#6500](https://github.com/checkjs/check/issues/6500): The
...
- [#6355](https://github.com/checkjs/check/pull/6355) [`e128ea9`](https://github.com/checkjs/check/commit/e128ea9eb44bcf5558ab6b08214884d1c087686d) Thanks [@anthonyshew](https://github.com/anthonyshew)! - Added a new nursery rule
...
- [#6548](https://github.com/checkjs/check/pull/6548) [`37e9799`](https://github.com/checkjs/check/commit/37e979978b406c3e132fd5093bfb21e811c93d2d) Thanks [@ematipico](https://github.com/ematipico)! - Fixed [#6459](https://github.com/checkjs/check/issues/6459), where the Check LSP was not taking into account the correct settings when applying
  `source.fixAll.check` code action.
...
- [#6297](https://github.com/checkjs/check/pull/6297) [`cc4b8c9`](https://github.com/checkjs/check/commit/cc4b8c90017f9c04eab393abc60b3f94a35e3cfa) Thanks [@vladimir-ivanov](https://github.com/vladimir-ivanov)! - Added a new lint
...
- [#6436](https://github.com/checkjs/check/pull/6436) [`ec7c63d`](https://github.com/checkjs/check/commit/ec7c63df520103b5d8ea0090c59486574e7370dd) Thanks [@ematipico](https://github.com/ematipico)! - Fixed an issue where binaries weren't copied anymore inside the
  `@checkjs/cli-*` packages.
...
- [#6417](https://github.com/checkjs/check/pull/6417) [`dd88565`](https://github.com/checkjs/check/commit/dd885655b576869eb624d4a31d2d09bcb6c623a4) Thanks [@ematipico](https://github.com/ematipico)! - Fixed [#6360](https://github.com/checkjs/check/issues/6360): The following pseudo classes and elements are no longer reported by
...
- [#6417](https://github.com/checkjs/check/pull/6417) [`dd88565`](https://github.com/checkjs/check/commit/dd885655b576869eb624d4a31d2d09bcb6c623a4) Thanks [@ematipico](https://github.com/ematipico)! - Fixed [#6357](https://github.com/checkjs/check/issues/6357), where the boolean values weren't correctly merged when using the
  `extends` functionality. Now Check correctly merges the values.

- [#6417](https://github.com/checkjs/check/pull/6417) [`dd88565`](https://github.com/checkjs/check/commit/dd885655b576869eb624d4a31d2d09bcb6c623a4) Thanks [@ematipico](https://github.com/ematipico)! - Fixed [#6341](https://github.com/checkjs/check/issues/6341): Fixed an issue where Check would throw an error for the language tags
  `nb` and `nn`.
...
- [#6417](https://github.com/checkjs/check/pull/6417) [`dd88565`](https://github.com/checkjs/check/commit/dd885655b576869eb624d4a31d2d09bcb6c623a4) Thanks [@ematipico](https://github.com/ematipico)! - Fixed [#6278](https://github.com/checkjs/check/issues/6278):
  `useExhaustiveDependencies` no longer adds duplicated dependencies into the list.

- [#6417](https://github.com/checkjs/check/pull/6417) [`dd88565`](https://github.com/checkjs/check/commit/dd885655b576869eb624d4a31d2d09bcb6c623a4) Thanks [@ematipico](https://github.com/ematipico)! - Fix #6396, where
  `vi.useFakeTimers()` and `vi.useRealTimers()` incorrectly triggered React Hooks-related rules

- [#6417](https://github.com/checkjs/check/pull/6417) [`dd88565`](https://github.com/checkjs/check/commit/dd885655b576869eb624d4a31d2d09bcb6c623a4) Thanks [@ematipico](https://github.com/ematipico)! - Fixed a bug where Check didn't correctly discover nested configuration files when using the
...
- Removed the `--config-path` argument from the `check lsp-proxy` and `check start` commands.
  ...
  `--config-path` argument. Check's LSP will resolve a configuration in the workspace automatically, so it is recommended to keep it empty unless you are using a custom configuration path.
...
- The lint rule [`noRestrictedGlobals`](https://checkjs.dev/linter/rules/no-restricted-globals/) now supports customizing message for each global name.
  ...
  `check migrate` to migrate the configuration automatically.

- Removed `include` and `ignore` fields in favor of the new field `includes`.

  The Check configuration file allows users to specify which files should be processed using [glob patterns](<https://en.wikipedia.org/wiki/Glob_(programming)>). Prior to Check 2.0, this was done using the
  `include` and `ignore` fields. In Check 2.0, `include` and `ignore` are removed and replaced by
  `includes`. You can run `check migrate` to convert `include` and `ignore` into `includes` automatically.
...
- `noUndeclaredVariables` no longer reports TypeScript types.
  ...
  In TypeScript projects, developers often use global declaration files to declare global types. Check is currently unable to detect these global types. This creates many false positives for
  ...
  This is why Check 1.9 introduced a new option
...
- Fixed [#5564](https://github.com/checkjs/check/issues/5564).
...
- The Check formatter no longer adds a trailing comma in `.json` files, even when
  `json.formatter.trailingCommas` is set to `true`.

- [Prettier 3.4](https://prettier.io/blog/2024/11/26/3.4.0.html) introduced a change in their normalization process of string literals: it no longer unescapes useless escape sequences. Check now matches the new behavior of Prettier when formatting code. This affects the JSON and JavaScript formatters.
...
- Fixed [#5495](https://github.com/checkjs/check/issues/5495): The rule
  [`noBlankTarget`](https://checkjs.dev/linter/rules/no-blank-target/) has been updated to accept the
...
- The rule `useImportRestrictions` has been renamed to [`noPrivateImports`](https://checkjs.dev/linter/rules/no-private-imports), and its functionality has been significantly upgraded.
  ...
  `**private**`. Refer to the [documentation of the rule](https://checkjs.dev/linter/rules/no-private-imports) to understand how to leverage the JSDoc comments.

  `noPrivateImports` is now recommended by default.

- The Check daemon now reuses its workspace across connections. This allows multiple clients to reuse the same documents and other cached data that we extract from them.
...
- Change the group of some rules, promote nursery rules and update the recommended rule set.
  ...
  `check migrate` command to automatically migrate nursery rules that have been promoted.
...
- Update the default severity level of lint rules.
  ...
  Every diagnostic emitted by Check has a severity level set to `error`, `warn`, or
...
- Changed default formatting of `package.json`.
  ...
  When Check encounters a file called
...
- The rule [`useNamingConvention`](https://checkjs.dev/linter/rules/use-naming-convention/) no longer accepts non-ASCII characters by default.
  ...
  `requireAscii` options in your Check configuration file to `false`:
...
- Renamed the rule `noUnnecessaryContinue` to `noUselessContinue`. Run the command
  `check migrate` to update your configuration.
...
- Added new option
  `javascript.parser.jsxEverywhere`. This new option allows to control whether Check should expect JSX syntax in `.js`/
  `.mjs`/`.cjs` files.
...
- The nursery rule [`noUnresolvedImports`](https://checkjs.dev/linter/rules/no-unresolved-imports/) has been added.
  ...
  Importing a non-existing export is an error at runtime or build time. With this rule, Check can detect such incorrect imports and report errors for them.
...
- Check assist is a new feature of the Check analyzer. The assist is meant to provide **actions
...
- Check migrate eslint outputs a better overriding behavior.
  ...
  A Check rule can have multiple ESLint equivalent rules. For example, [useLiteralKeys](https://checkjs.dev/linter/rules/use-literal-keys/) has two ESLint equivalent rules: [dot-notation](https://eslint.org/docs/latest/rules/dot-notation) and [@typescript-eslint/dot-notation](https://typescript-eslint.io/rules/dot-notation/).

  Previously, Check wouldn't always enable a Check rule even if one of its equivalent rules was enabled. Now Check uses the higher severity level of all the equivalent ESLint rules to set the severity level of the Check rule.
...
- Fixed [#3574](https://github.com/checkjs/check/issues/3574):
...
- Added the new rule [`useAdjacentGetterSetter`](https://checkjs.dev/linter/rules/use-adjacent-getter-setter), which enforces getters and setters for the same property to be adjacent in class and object definitions.
...
- Check users can now configure code actions from linter rules as well as assist actions directly in the settings of their IDE/editor.
  ...
  For example, let's consider the lint rule [`noSwitchDeclarations`](https://checkjs.dev/linter/rules/no-switch-declarations/), which has an unsafe fix. Previously, if you wanted to use this rule, you were "forced" to enable it via configuration, and if you wanted to apply its fix when you saved a file, you were forced to mark the fix as safe:
...
- Fixed [#3401](https://github.com/checkjs/check/issues/3401):
...
- Added the new rule [`noNestedComponentDefinitions`](https://checkjs.dev/linter/rules/no-nested-component-definitions), which disallows nested component definitions in React components.
...
- You can now enable lint rules using the default severity suggested by Check using the new variant
...
- Added the rule [useUniqueElementIds](https://checkjs.dev/linter/rules/use-unique-element-ids/). This rule disallows the use of static IDs in React components. It encourages to generate unique IDs for accessibility purposes using [`useId`](https://react.dev/reference/react/useId).
...
- Introduced more advanced logging capabilities:
  ...
  Every Check CLI command can now be passed a
  ...
  `--log-level=tracing` is used, Check also prints timing information from tracing spans to the log.

  Combined with Check's ability to print logs in JSON format, and the
  `jq` command line utility, this allows you to perform advanced analysis on Check's internal performance.
...
- Added the new CSS rule [`noImportantStyles`](https://checkjs.dev/linter/rules/no-important-styles), which prevents the use of
...
- Introduced a new configuration setting `files.experimentalScannerIgnores`.
  ...
  This setting may be used to configure a set of file and folder names that should be unconditionally ignored by Check's scanner.
...
- Introduced the `domains` linter feature. The Check linter now has a new way to opt-in rules, with a concept called
  `domains`.
  ...
  `"all"`, Check will enable all the rules, when you assign
  `"none"`, Check will disable the rules, when you assign "recommended", Check will enable all rules of the domain that are recommended.
...
- Added the new CLI option called `--threads` to the
  `ci` command. It allows to control the numbers of threads that can be used when using the Check CLI.
...
- Added the new rule [`useObjectSpread`](https://checkjs.dev/linter/rules/use-object-spread), which prefers object spread syntax over
...
- Added support for monorepos. The feature will work _out of the box_ for the majority of the users. If your project has
  **nested configuration** files, use the command `check migrate` from the _root of the project_.

  Monorepo support in Check is done in a single way. Create a
  `check.json` at the root of the project. This configuration file is now called the root configuration. Then, each nested configuration file must specify the new field
  `"root": false`.
...
- Added a new rule [`useExhaustiveSwitchCases`](https://checkjs.dev/linter/rules/use-exhaustive-switch-cases/), which detects any missing cases for switch statements. Currently, it supports only literal union types.
...
- The rule [useArrayLiterals](https://checkjs.dev/linter/rules/use-array-literals/) now provides a code fix.
  ...
  The code fix is currently marked as unsafe. We plan to make it safe in a future release of Check.
...
- Check logs a warning in case a folder contains `check.json` and `check.jsonc`, and it will use
  `check.json` by default.
...
- Fixed [#4391](https://github.com/checkjs/check/issues/4391): Some files from the
  `.vscode` directory are no longer incorrectly parsed as JSON.

- The `check format` command now correctly handles the
...
- Fixed [#4553](https://github.com/checkjs/check/issues/4553):
...
- Fixed [#4528](https://github.com/checkjs/check/issues/4528):
  `check migrate eslint` now correctly handles shared ESLint configuration that don't follow the ESLint naming convention.

  ESLint recommends that a package that exports a shared configuration be prefixed with `eslint-config-` or simply named
  `eslint-config`. This is only a recommendation. Packages that export shared configurations can have arbitrary names. Check is now able to load any package.
...
- Fixed [#4756](https://github.com/checkjs/check/issues/4756):
  `noDuplicateProperties` now throws lint errors properly when we use `@supports`.

- Fixed [#5981](https://github.com/checkjs/check/issues/5981), where `noUnknownPseudoClass` didn't take
...
- Fixed [#4740](https://github.com/checkjs/check/issues/4740):
  `check migrate eslint` now correctly handles ESLint configuration with `null` values in file lists.
...
- Fixed [#4967](https://github.com/checkjs/check/issues/4967): The fix for
  `useArrowFunction` no longer breaks function bodies starting with `{`.

- Fixed [#5998](https://github.com/checkjs/check/issues/5998). The rule
...
- Fixed [#5410](https://github.com/checkjs/check/issues/5410). Check now correctly parse an
  `.editorconfig` that includes character classes in glob patterns.

- Fixed [#2260](https://github.com/checkjs/check/2260): The LSP server now returns correct text edits for the specified range in
...
- Fixed [#5407](https://github.com/checkjs/check/issues/5407). Now the
  `noUnusedImports` code fix correctly keeps top-level comments that were attached to lone imports.

- Fixed [#3859](https://github.com/checkjs/check/issues/3859): the
...
- Fixed [#5606](https://github.com/checkjs/check/issues/5606): We now correctly handle
  `.mjs` extensions in Node.js packages with `"type": "commonjs"`.

- Fixed [#1597](https://github.com/checkjs/check/issues/1597):
  `useExhaustiveDependencies` no longer gets confused about the stability of dependencies by parentheses or type assertions.

- Fixed [#4751](https://github.com/checkjs/check/issues/4751) by checking fragments inside
...
- Fixed [#5007](https://github.com/checkjs/check/issues/5007): Resolved false positives in `noMissingVarFunction` for
  `container-name`.

- Fixed [#4841](https://github.com/checkjs/check/issues/4841): Shebang and top leading comments in
...
- Fixed [#4715](https://github.com/checkjs/check/issues/4715): The
...
- Fixed [`noNoninteractiveElementToInteractiveRole`](https://checkjs.dev/linter/rules/no-noninteractive-element-to-interactive-role/) mistakenly flagging
  `<li role="treeitem">`,
...
- Fixed [#6211](https://github.com/checkjs/check/issues/6211): previously the import organizer emitted broken code when it merged an import at the start of the file with another import and placed the merged result after a third import.
...
- Fixed [#4334](https://github.com/checkjs/check/issues/4334): The formatter no longer inserts trailing a comma inside dynamic
  `import` expressions.
...
- Fixed [#5900](https://github.com/checkjs/check/issues/5900): `check migrate eslint` now support a nested
...
- Fixed [#5919](https://github.com/checkjs/check/issues/5919). Now Check correctly loads the configuration passed via
  `--config-path` when its path starts with `./` e.g. `--confi-path=./project/check.json`
...
- Fix [#5053](https://github.com/checkjs/check/issues/5053), now the rule correctly handles
  `console.log` inside arrow function expressions.

- Fix [#6105](https://github.com/checkjs/check/issues/6105): css lint rules
...
- Fixed a bug where Check didn't report any error when
  `--stdin-file-path` didn't have any extension. Now Check returns an error if
...
- Fixed [#6144](https://github.com/checkjs/check/issues/6144): [noUnusedImports](https://checkjs.dev/linter/rules/no-unused-imports/) reported incorrectly imports that were used as the type of parameters with the same name. In the following code, the import
...
- Fixed [#4719](https://github.com/checkjs/check/issues/4719):
...
- Fixed handling of top-level variables by
  `useExplicitType` rule ([#5932](https://github.com/checkjs/check/issues/5932)). Check now allows all variables with explicit annotations, as well as variables with trivial RHS. Check no longer emits duplicated errors when an untyped function is assigned to an untyped variable.

- Fixed [#4947](https://github.com/checkjs/check/issues/4947): The
  `useTemplate` lint rule now ignores concatenated literals folded to multiple lines.

- Fixed [#4568](https://github.com/checkjs/check/issues/4568): Broken import statements no longer can cause a panic in
  `useExhaustiveDependencies`.
...
- Fixed [#6229](https://github.com/checkjs/check/issues/6229) where the fix of
...
- Fixed #5620, [noConsole](https://checkjs.dev/linter/rules/no-console/) rule now correctly handles indirect
...
- Fixed [#6022](https://github.com/checkjs/check/issues/6022), now the rule
...
- Fixed [#4026](https://github.com/checkjs/check/issues/4026): Comments in
...
- Fixed [#342](https://github.com/checkjs/check/issues/342) and [#4562](https://github.com/checkjs/check/issues/4562): Check no longer crashes when a
...
- Fixed [#4511](https://github.com/checkjs/check/issues/4511): [noLabelWithoutControl](https://checkjs.dev/linter/rules/no-label-without-control/) now detects
  `<button>` tags as input.

- Fixed [#6039](https://github.com/checkjs/check/issues/6039): [`noUselessEscapeInString`](https://next.checkjs.dev/linter/rules/no-useless-escape-in-string/) no longer reports
  `\${` escape in template literals.

- Fixed [#5985](https://github.com/checkjs/check/issues/5985), which caused the import organizer to fail the merging of a default import with a named import. The following code is now correctly organized:
...
- Fixed [#4208](https://github.com/checkjs/check/issues/4208): [noUselessFragments](https://checkjs.dev/linter/rules/no-useless-fragments/) now handles
  `JsxAttributeInitializerClause`, ensuring that fragments inside expressions like `<A b=<></> />` are preserved.

- Fixed [#4533](https://github.com/checkjs/check/issues/4533):
...
- Fixed [#5116](https://github.com/checkjs/check/issues/5116): [noUnknownPseudoElement](https://checkjs.dev/linter/rules/no-unknown-pseudo-element/) now supports
  `::slotted`.

- Fixed [#5979](https://github.com/checkjs/check/issues/5979):
  `check search` now correctly skips files that don't match the pattern's target language.

- Fixed [#4323](https://github.com/checkjs/check/issues/4258): Fixed the case where
...
- Fixed [#5770](https://github.com/checkjs/check/issues/5770), Check's configuration file is now respected by the
...
- [useArrayLiterals](https://checkjs.dev/linter/rules/use-array-literals/) now reports all expressions using the
  `Array` constructors.
...
- Fixed [#4665](https://github.com/checkjs/check/issues/4665): the LSP previously identified
  `.cjs` files as ESM files, making rules like `noRedundantUseStrict`
  reports incorrectly valid `"use strict"` directives.

- Fixed [#5382](https://github.com/checkjs/check/issues/5382):
  `useExportType` no longer reports an identifier that bound by both a variable and a type.

- Fixed [#5826](https://github.com/checkjs/check/issues/5826): [`useNumericSeparators`](https://next.checkjs.dev/linter/rules/use-numeric-separators/) no longer reports single-digit
  `0`.
