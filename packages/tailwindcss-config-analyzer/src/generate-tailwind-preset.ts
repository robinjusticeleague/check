...
const ROOT_PACKAGE_NAME = "@checkjs/monorepo";
const OUTPUT_PATH =
	"crates/check_js_analyze/src/lint/nursery/use_sorted_classes/tailwind_preset.rs";
...
//! To update, run \`pnpm gen:tailwind-preset\` from \`packages/@checkjs/tailwindcss-config-analyzer\`.
