...
///
/// ```rust
/// use check_formatter::{SimpleFormatContext, format, format_args};
...
/// ```rust
/// use check_formatter::prelude::*;
/// use check_formatter::{Buffer, FormatState, SimpleFormatContext, VecBuffer, write};
///
/// # fn main() -> FormatResult<()> {
...
/// ```rust
/// use check_formatter::prelude::*;
/// use check_formatter::{FormatState, VecBuffer};
///
/// # fn main() -> FormatResult<()> {
/// let mut state = FormatState::new(SimpleFormatContext::default());
/// let mut buffer = VecBuffer::new(&mut state);
...
///
/// ```
/// use check_formatter::{Formatted, LineWidth, format, format_args, SimpleFormatOptions};
/// use check_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
