...
///
/// Running Check formatter on real world use cases showed that more than 99.99% of comments get inserted in
/// the described order.
///
/// The size limitation isn't a concern for comments because Check supports source documents with a size up to 4GB (`u32::MAX`)
