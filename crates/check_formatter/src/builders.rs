...
use Tag::*;
use check_rowan::{Language, SyntaxNode, SyntaxToken, TextLen, TokenText};
use std::borrow::Cow;
use std::cell::Cell;
...
/// ```
/// use check_formatter::{format, format_args, LineWidth, SimpleFormatOptions};
/// use check_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
...
/// ```
/// use check_formatter::{format_args, format, LineWidth, SimpleFormatOptions};
/// use check_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
/// let context = SimpleFormatContext::new(SimpleFormatOptions {
...
/// ```rust
/// # use check_formatter::prelude::*;
/// # use check_formatter::{format, write, LineWidth};
///
...
/// ```
/// use check_formatter::prelude::*;
/// use check_formatter::{format, format_args, IndentStyle, IndentWidth, SimpleFormatOptions};
///
/// # fn main() -> FormatResult<()> {
///     let context = SimpleFormatContext::new(SimpleFormatOptions {
...
/// ```
/// use std::num::NonZeroU8;
/// use check_formatter::{format, format_args, IndentStyle, SimpleFormatOptions};
/// use check_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
/// let context = SimpleFormatContext::new(SimpleFormatOptions {
...
///
/// ```
/// use check_formatter::{format, format_args, LineWidth};
/// use check_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
/// let elements = format!(SimpleFormatContext::default(), [
...
/// use check_formatter::{format_args, format, LineWidth, SimpleFormatOptions};
/// use check_formatter::prelude::*;
/// use check_formatter::printer::PrintWidth;
///
/// fn main() -> FormatResult<()> {
/// let context = SimpleFormatContext::new(SimpleFormatOptions {
///     line_width: LineWidth::try_from(20).unwrap(),
...
impl<Context> IfGroupBreaks<'_, Context> {
    ...
    ///
    /// ```
    /// use check_formatter::{format, format_args, write, LineWidth, SimpleFormatOptions};
    /// use check_formatter::prelude::*;
    ///
    /// # fn main() -> FormatResult<()> {
    /// let context = SimpleFormatContext::new(SimpleFormatOptions {
...
/// ```
/// use check_formatter::{format, format_args, LineWidth, SimpleFormatOptions, write};
/// use check_formatter::prelude::*;
///
/// # fn main() -> FormatResult<()> {
...
/// ```
/// use check_formatter::prelude::*;
/// use check_formatter::{SimpleFormatContext, format, write};
...
/// ```
/// use check_formatter::prelude::*;
/// use check_formatter::{SimpleFormatContext, format, write, Buffer};
///
/// struct MyFormat;
///
