...
use check_json_value::{JsonObject, JsonValue};
use check_package::{PackageJson, TsConfigJson};
...
pub struct ResolveOptions<'a> {
    ...
    /// extension is also specified). Check uses this in the `extends` field of
