...
use check_json_value::JsonValue;
...
impl Manifest for PackageJson {
    ...
    fn read_manifest(fs: &dyn check_fs::FileSystem, path: &Utf8Path) -> Deserialized<Self> {
...
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq, check_deserialize_macros::Deserializable)]
...
mod tests {
    ...
    "exports": {
        ...
        assert_eq!(package_json.author, Some("Check Team".into()));
    }
