...
///
/// ```
/// use check_package::node_semver::{Range, Version};
///
...
impl Range {
    ...
    ///
    /// ```
    /// use check_package::node_semver::{Comparator, ComparatorOperator, Range, Version};
    ///
    ...
    ///
    /// ```
    /// use check_package::node_semver::Range;
    ///
...
impl Comparator {
    ...
    ///
    /// ```
    /// use check_package::node_semver::{Comparator, ComparatorOperator, Version};
    ///
