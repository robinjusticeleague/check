...
#[derive(Debug, Default, check_deserialize_macros::Merge, serde::Deserialize)]
struct Aria {
...
#[derive(
    Clone, Copy, Debug, Default, Eq, PartialEq, check_deserialize_macros::Merge, serde::Deserialize,
)]
enum AriaValueType {
    #[default]
