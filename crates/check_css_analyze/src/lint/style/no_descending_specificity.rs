...
use check_css_semantic::model::{Rule as CssSemanticRule, RuleId, SemanticModel, Specificity};
use check_css_syntax::{AnyCssSelector, CssRoot};
use check_diagnostics::Severity;
use check_rowan::TextRange;

use check_rowan::AstNode;
use check_rule_options::no_descending_specificity::NoDescendingSpecificityOptions;
