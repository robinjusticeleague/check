...
use check_css_semantic::builder::SemanticModelBuilder;
use check_css_semantic::{SemanticEventExtractor, model::SemanticModel};
use check_css_syntax::{CssLanguage, CssRoot, CssSyntaxNode};
use check_rowan::{AstNode, TextRange, WalkEvent};
...
impl Queryable for SemanticServices {
    ...
    fn build_visitor(
        ...
        root: &<Self::Language as check_rowan::Language>::Root,
    ) {
