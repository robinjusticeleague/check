...
// https://github.com/checkjs/check/issues/609
...
// https://github.com/checkjs/check/issues/607
...
// https://github.com/checkjs/check/issues/608
...
// Namespaced imports
// https://github.com/checkjs/check/issues/578
...
// https://github.com/checkjs/check/issues/651
...
// https://github.com/checkjs/check/issues/1637
...
// https://github.com/checkjs/check/issues/2361
...
// https://github.com/checkjs/check/discussions/2509
function IgnoredDependencies() {
    const [foo, setFoo] = useState(1);
    // check-ignore lint/correctness/useExhaustiveDependencies(foo): foo should be listed, but we override it
    // check-ignore lint/correctness/useExhaustiveDependencies(setFoo): setFoo shouldn't be listed, but we override it
    useEffect(() => {
        setFoo(foo + 1);
    }, [setFoo]);
}
...
function IgnoredDependencies2() {
    const [foo, setFoo] = useState(1);
    // check-ignore lint/correctness/useExhaustiveDependencies: both are ignored.
    useEffect(() => {
        setFoo(foo + 1);
    }, [setFoo]);
}
