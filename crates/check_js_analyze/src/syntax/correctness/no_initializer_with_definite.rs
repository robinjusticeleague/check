use check_analyze::{Ast, Rule, RuleDiagnostic, context::RuleContext, declare_syntax_rule};
use check_js_syntax::{JsVariableDeclarator, TextRange, TsDefiniteVariableAnnotation};
