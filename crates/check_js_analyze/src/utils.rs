use check_js_syntax::{AnyJsExpression, JsBinaryExpression, JsSyntaxNode, inner_string_text};
use check_rowan::{AstNode, Direction, WalkEvent};
use std::iter;
...
mod test {
    ...
    use check_js_syntax::{JsBinaryExpression, JsFileSource};
