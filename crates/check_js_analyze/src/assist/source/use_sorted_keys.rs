...
use check_js_syntax::{JsObjectExpression, JsObjectMemberList, T};
use check_rowan::{AstNode, BatchMutationExt, TriviaPieceKind};
use check_rule_options::use_sorted_keys::{SortOrder, UseSortedKeysOptions};
...
declare_source_rule! {
    ...
    ///
    /// `// check-ignore assist/source/useSortedKeys`
    ///
    /// ## Examples
    ///
    /// ```js,expect_diff
