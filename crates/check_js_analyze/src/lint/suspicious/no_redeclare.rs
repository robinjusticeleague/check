...
use check_analyze::{Rule, RuleDiagnostic, context::RuleContext};
use check_analyze::{RuleSource, declare_lint_rule};
use check_console::markup;
use check_diagnostics::Severity;
use check_js_semantic::Scope;
use check_js_syntax::binding_ext::AnyJsBindingDeclaration;
use check_js_syntax::{JsSyntaxKind, TextRange};
use check_rowan::AstNode;
use check_rule_options::no_redeclare::NoRedeclareOptions;
