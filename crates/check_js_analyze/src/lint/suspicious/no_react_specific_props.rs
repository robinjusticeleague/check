...
use check_js_factory::make::{jsx_ident, jsx_name};
use check_js_syntax::{AnyJsxAttributeName, JsxAttribute};
use check_rowan::{AstNode, BatchMutationExt, TextRange};
use check_rule_options::no_react_specific_props::NoReactSpecificPropsOptions;
