...
use check_js_syntax::{TsInterfaceDeclaration, binding_ext::AnyJsBindingDeclaration};
use check_rowan::{AstNode, TextRange};
use check_rule_options::no_unsafe_declaration_merging::NoUnsafeDeclarationMergingOptions;
