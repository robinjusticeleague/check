...
use check_js_syntax::{JsFileSource, JsImport};
use check_rowan::AstNode;
use check_rule_options::no_document_import_in_page::NoDocumentImportInPageOptions;
...
declare_lint_rule! {
    ...
    pub NoDocumentImportInPage {
        ...
        language: "jsx",
        sources: &[RuleSource::EslintNext("no-document-import-in-page").same()],
        recommended: true,
