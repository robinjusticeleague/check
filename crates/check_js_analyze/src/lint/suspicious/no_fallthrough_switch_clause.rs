...
use check_control_flow::{
    ExceptionHandlerKind, InstructionKind,
    builder::{BlockId, ROOT_BLOCK_ID},
};
use check_diagnostics::Severity;
use check_js_syntax::{JsDefaultClause, JsLanguage, JsSwitchStatement, JsSyntaxNode};
use check_rowan::{AstNode, AstNodeList, TextRange, WalkEvent};
use check_rule_options::no_fallthrough_switch_clause::NoFallthroughSwitchClauseOptions;
...
fn register_fallthrough_switch_clauses(
    ...
    cfg: &check_control_flow::ControlFlowGraph<JsLanguage>,
