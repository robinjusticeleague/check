...
use check_js_syntax::{AnyJsxTag, JsxChildList};
use check_rowan::{AstNodeList, TextRange};
use check_rule_options::no_suspicious_semicolon_in_jsx::NoSuspiciousSemicolonInJsxOptions;
