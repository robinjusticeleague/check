...
use check_analyze::{Ast, FixKind, Rule, RuleDiagnostic, declare_lint_rule};
use check_console::markup;
use check_diagnostics::Severity;
use check_js_syntax::TsEnumDeclaration;
use check_rowan::{AstNode, BatchMutationExt, chain_trivia_pieces, trim_leading_trivia_pieces};
use check_rule_options::no_const_enum::NoConstEnumOptions;
...
impl Rule for NoConstEnum {
    ...
    type Options = NoConstEnumOptions;
