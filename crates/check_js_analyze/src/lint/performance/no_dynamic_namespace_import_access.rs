use check_analyze::{Rule, RuleDiagnostic, context::RuleContext, declare_lint_rule};
use check_console::markup;
use check_diagnostics::Severity;
use check_js_semantic::ReferencesExtensions;
use check_js_syntax::{JsComputedMemberExpression, JsImportNamespaceClause};
use check_rowan::{AstNode, TextRange};
use check_rule_options::no_dynamic_namespace_import_access::NoDynamicNamespaceImportAccessOptions;
...
declare_lint_rule! {
    ...
    ///
    /// If you want to completely disallow namespace imports, consider using the [noNamespaceImport](https://checkjs.dev/linter/rules/no-namespace-import/) rule.
    ///
    /// ## Examples
    ///
    /// ### Invalid
