...
use check_rowan::{AstNode, WalkEvent, declare_node_union};
use check_rule_options::no_await_in_loops::NoAwaitInLoopsOptions;
...
impl Rule for NoAwaitInLoops {
    type Query = Ast<AnyLoopNode>;
    type State = JsSyntaxNode;
    type Signals = Option<Self::State>;
    type Options = NoAwaitInLoopsOptions;
