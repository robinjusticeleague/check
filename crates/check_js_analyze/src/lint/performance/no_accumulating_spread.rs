...
use check_rowan::{AstNode, AstSeparatedList, TextRange, declare_node_union};
use check_rule_options::no_accumulating_spread::NoAccumulatingSpreadOptions;
...
// https://github.com/checkjs/check/issues/5277
