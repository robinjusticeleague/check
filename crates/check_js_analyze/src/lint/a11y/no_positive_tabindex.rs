...
use check_analyze::{FixKind, Rule, RuleDiagnostic, RuleSource, declare_lint_rule};
use check_console::markup;
use check_diagnostics::Severity;
use check_js_factory::make;
use check_js_factory::make::{jsx_string, jsx_string_literal};
use check_js_semantic::SemanticModel;
...
use check_rowan::{AstNode, BatchMutationExt, declare_node_union};
use check_rule_options::no_positive_tabindex::NoPositiveTabindexOptions;
    ...
    fn action(ctx: &RuleContext<Self>, _: &Self::State) -> Option<JsRuleAction> {
        ...
        match tabindex_attribute {
            ...
            TabindexProp::JsPropertyObjectMember(js_object_member) => {
                ...
                let new_val = check_js_syntax::AnyJsExpression::AnyJsLiteralExpression(
