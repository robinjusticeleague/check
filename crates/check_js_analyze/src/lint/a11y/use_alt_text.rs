...
use check_console::{fmt::Display, fmt::Formatter, markup};
use check_diagnostics::Severity;
use check_js_syntax::{TextRange, jsx_ext::AnyJsxElement, static_value::StaticValue};
use check_rowan::AstNode;
use check_rule_options::use_alt_text::UseAltTextOptions;
