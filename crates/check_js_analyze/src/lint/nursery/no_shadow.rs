...
use check_js_semantic::{Binding, SemanticModel};
use check_js_syntax::{
...
use check_rowan::{AstNode, SyntaxNodeCast, TokenText, declare_node_union};
use check_rule_options::no_shadow::NoShadowOptions;
...
declare_lint_rule! {
    ...
    ///
    /// See also: [`noShadowRestrictedNames`](http://checkjs.dev/linter/rules/no-shadow-restricted-names)
    ///
    /// ## Examples
    ///
    /// ### Invalid
