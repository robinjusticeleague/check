...
use check_js_syntax::{AnyJsExpression, AnyJsStatement, JsFileSource, JsObjectExpression, T};
use check_rowan::{AstNode, TextRange, TriviaPieceKind};
use check_rowan::{BatchMutationExt, SyntaxNodeCast};
use check_rule_options::no_vue_data_object_declaration::NoVueDataObjectDeclarationOptions;
