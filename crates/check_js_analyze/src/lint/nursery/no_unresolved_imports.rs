...
use check_module_graph::{JsImportPath, JsModuleInfo, ModuleGraph, SUPPORTED_EXTENSIONS};
use check_resolver::ResolveError;
use check_rowan::{AstNode, SyntaxResult, Text, TextRange, TokenText};
use check_rule_options::no_unresolved_imports::NoUnresolvedImportsOptions;
...
declare_lint_rule! {
    ...
    /// Check can detect such incorrect imports and report errors for them.
    ///
