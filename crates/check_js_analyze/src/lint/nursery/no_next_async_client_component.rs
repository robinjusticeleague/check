...
use check_js_syntax::{AnyJsExpression, AnyJsRoot};
use check_rowan::{AstNode, TokenText};
use check_rule_options::no_next_async_client_component::NoNextAsyncClientComponentOptions;
...
fn has_use_client_directive(
    directives: impl IntoIterator<Item = check_js_syntax::JsDirective>,
) -> bool {
