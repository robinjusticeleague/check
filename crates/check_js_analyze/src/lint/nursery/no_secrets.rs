...
use check_js_syntax::JsStringLiteralExpression;
use check_rowan::AstNode;
use check_rule_options::no_secrets::NoSecretsOptions;
use regex::Regex;
    ...
    fn diagnostic(ctx: &RuleContext<Self>, state: &Self::State) -> Option<RuleDiagnostic> {
        ...
        Some(
            ...
            .note(markup! {
                ...
                "\n3. If this is a false positive, consider adding an inline disable comment, or tweak the entropy threshold. See options "<Hyperlink href="https://checkjs.dev/linter/rules/no-secrets/#options">"in our docs."</Hyperlink>
                "\nThis rule only catches basic vulnerabilities. For more robust, proper solutions, check out our recommendations at: "<Hyperlink href="https://checkjs.dev/linter/rules/no-secrets/#recommendations">"https://checkjs.dev/linter/rules/no-secrets/#recommendations"</Hyperlink>
            })
        )
    }
}
