...
use check_js_factory::make::{jsx_attribute_list, jsx_self_closing_element};
use check_js_syntax::{
    AnyJsxAttribute, JsCallExpression, JsPropertyObjectMember, JsxAttribute, JsxElement,
    JsxSelfClosingElement,
};
use check_rowan::{AstNode, AstNodeList, BatchMutationExt, declare_node_union};
use check_rule_options::no_void_elements_with_children::NoVoidElementsWithChildrenOptions;
