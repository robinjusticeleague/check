...
use check_js_syntax::{AnyJsExpression, JsCallExpression, JsNewExpression, global_identifier};
use check_rowan::{SyntaxResult, TextRange, declare_node_union};
use check_rule_options::no_global_object_calls::NoGlobalObjectCallsOptions;
