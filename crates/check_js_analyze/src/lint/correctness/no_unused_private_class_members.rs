...
use check_rule_options::no_unused_private_class_members::NoUnusedPrivateClassMembersOptions;
        ...
        .flat_map(|constructor_params| {
            constructor_params
                ...
                .filter_map(|param| match param.ok()? {
                    check_js_syntax::AnyJsConstructorParameter::TsPropertyParameter(
                        ts_property,
