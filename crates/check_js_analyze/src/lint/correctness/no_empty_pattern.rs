...
use check_js_syntax::{JsArrayBindingPattern, JsObjectBindingPattern};
use check_rowan::{AstNode, AstSeparatedList, declare_node_union};
use check_rule_options::no_empty_pattern::NoEmptyPatternOptions;
