...
use check_analyze::{Ast, Rule, RuleDiagnostic, declare_lint_rule};
use check_console::markup;
use check_diagnostics::Severity;
use check_js_syntax::{JsConstructorClassMember, JsReturnStatement};
use check_rowan::AstNode;
use check_rule_options::no_constructor_return::NoConstructorReturnOptions;
