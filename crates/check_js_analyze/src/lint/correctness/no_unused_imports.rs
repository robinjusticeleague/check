...
use check_rule_options::no_unused_imports::NoUnusedImportsOptions;
...
use check_js_factory::make::{js_identifier_binding, js_module, js_module_item_list};
...
declare_lint_rule! {
    ...
    /// ## Options
    ///
    /// This rule respects the [`jsxRuntime`](https://checkjs.dev/reference/configuration/#javascriptjsxruntime)
    ...
    fn run(ctx: &RuleContext<Self>) -> Self::Signals {
        match ctx.query() {
            ...
            AnyJsImportClause::JsImportNamedClause(clause) => {
                ...
                // eg. `import type {} from ...`
                // https://github.com/checkjs/check/issues/6669
