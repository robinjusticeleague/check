...
use check_rowan::{AstSeparatedList, BatchMutationExt, TriviaPieceKind, declare_node_union};
use check_rule_options::no_global_dirname_filename::NoGlobalDirnameFilenameOptions;
...
fn make_property_object_member(
    ...
    make::js_property_object_member(
        check_js_syntax::AnyJsObjectMemberName::JsLiteralMemberName(make::js_literal_member_name(
