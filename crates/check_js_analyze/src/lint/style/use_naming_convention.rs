...
use check_js_semantic::{CanBeImportedExported, SemanticModel};
use check_js_syntax::{
...
use check_string_case::{Case, Cases};
use check_unicode_table::is_js_ident;
use enumflags2::BitFlags;
use smallvec::SmallVec;

pub use check_rule_options::use_naming_convention::{
        ...
        match suggestion {
            Suggestion::Ascii => {
                Some(RuleDiagnostic::new(
                    ...
                    "If you want to use non-ASCII names, then set the "<Emphasis>"requireAscii"</Emphasis>" option to `false`.\nSee the rule "<Hyperlink href="https://checkjs.dev/linter/rules/use-naming-convention#options">"options"</Hyperlink>" for more details."
                }))
            }
