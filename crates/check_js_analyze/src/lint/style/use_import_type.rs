...
use check_rule_options::use_import_type::{Style, UseImportTypeOptions};
...
declare_lint_rule! {
    ...
    ///
    /// Since Check doesn't know how a decorator is implemented,
    /// it is unable to detect that an import used as a type is also used as a value in the code generated by a decorator.
    /// This leads Check to suggest importing some imports as type, which are actually used as value at runtime.
    ///
