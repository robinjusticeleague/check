...
use check_rowan::{AstNode, AstSeparatedList, BatchMutationExt, TokenText};
use check_rule_options::use_explicit_length_check::UseExplicitLengthCheckOptions;
...
declare_lint_rule! {
    ...
    /// ```
    ///
    /// To properly handle this case, type inference would be required, which is not supported by Check at the moment.
