...
use check_rule_options::use_consistent_builtin_instantiation::UseConsistentBuiltinInstantiationOptions;
...
declare_lint_rule! {
    ...
    /// [noInvalidBuiltinInstantiation](https://checkjs.dev/linter/rules/no-invalid-builtin-instantiation/) rule.
    ///
    /// ## Examples
    ///
    /// ### Invalid
