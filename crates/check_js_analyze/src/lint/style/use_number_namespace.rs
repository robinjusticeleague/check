...
use check_rule_options::use_number_namespace::UseNumberNamespaceOptions;
...
declare_lint_rule! {
    ...
    /// You can use the dedicated rules [noGlobalIsFinite](https://checkjs.dev/linter/rules/no-global-is-finite/) and  [noGlobalIsNan](https://checkjs.dev/linter/rules/no-global-is-nan/) to enforce the use of `Number.isFinite` and `Number.isNaN`.
    ///
    /// ## Examples
    ///
    /// ### Invalid
    ...
    pub UseNumberNamespace {
        ...
        language: "js",
        sources: &[RuleSource::EslintUnicorn("prefer-number-properties").same()],
        recommended: false,
