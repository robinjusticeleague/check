...
declare_lint_rule! {
    ...
    ///
    /// To prevent use of commonly misleading types, you can refer to [noBannedTypes](https://checkjs.dev/linter/rules/no-banned-types/)
    ///
    /// ## Options
    ///
