...
use check_js_semantic::{Binding, BindingExtensions};
use check_js_syntax::{AnyJsIdentifierUsage, TextRange};
use check_rowan::AstNode;
use check_rule_options::no_restricted_globals::NoRestrictedGlobalsOptions;
