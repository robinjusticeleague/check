...
use check_js_syntax::{AnyJsSwitchClause, JsCaseClause, JsDefaultClause};
use check_rowan::{AstNode, AstNodeList, BatchMutationExt, Direction};
use check_rule_options::no_useless_switch_case::NoUselessSwitchCaseOptions;
