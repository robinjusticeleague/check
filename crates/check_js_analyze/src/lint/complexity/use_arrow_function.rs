...
use check_rule_options::use_arrow_function::UseArrowFunctionOptions;
...
fn needs_parentheses(function_expression: &JsFunctionExpression) -> bool {
    function_expression.syntax().parent().is_some_and(|parent| {
        ...
        // in the `check_js_formatter` crate.
        // TODO: Should `NeedsParentheses` be moved in `check_js_syntax`?
        matches!(
            parent.kind(),
