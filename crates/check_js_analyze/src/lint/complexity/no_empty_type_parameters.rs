...
use check_js_syntax::{JsSyntaxKind, TsTypeParameters};
use check_rowan::{AstNode, AstSeparatedList, SyntaxNodeOptionExt};
use check_rule_options::no_empty_type_parameters::NoEmptyTypeParametersOptions;
