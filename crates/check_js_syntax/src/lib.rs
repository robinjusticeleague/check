...
//! Both rome_js_lexer and check_js_parser rely on these definitions, therefore
...
use check_rowan::{AstNode, RawSyntaxKind, SyntaxKind, SyntaxResult};
...
impl check_rowan::SyntaxKind for JsSyntaxKind {
...
///
/// ```
/// use check_js_syntax::{JsSyntaxKind, JsSyntaxToken, inner_string_text};
///
