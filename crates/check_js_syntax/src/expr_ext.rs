...
impl JsReferenceIdentifier {
    ...
    ///
    /// ```
    /// use check_js_factory::make::{js_reference_identifier, ident};
    ///
...
impl JsLiteralMemberName {
    ...
    ///
    /// ```
    /// use check_js_syntax::{JsSyntaxKind, JsLanguage, JsSyntaxNode, JsLiteralMemberName};
...
impl JsBinaryOperator {
    ...
    ///
    /// ```
    /// use check_js_syntax::JsBinaryOperator;
    ///
...
impl JsTemplateExpression {
    ...
    /// ```
    /// use check_js_factory::make;
    /// use check_js_syntax::{AnyJsExpression, AnyJsTemplateElement, JsSyntaxKind, JsSyntaxToken};
    /// use std::iter;
    ///
...
impl JsRegexLiteralExpression {
    ...
    /// ```
    /// use check_js_factory::make;
    /// use check_js_syntax::{JsSyntaxKind, JsSyntaxToken};
    ///
...
impl AnyJsExpression {
    ...
    pub fn contains_only_each_pattern(&self) -> SyntaxResult<bool> {
        ...
        if let (Some(first_token), Some(second_token), Some(third_token)) =
            (&first, &second, &third)
        {
...
impl AnyJsMemberExpression {
    ...
    ///
    /// ```
    /// use check_js_syntax::{AnyJsExpression, AnyJsLiteralExpression, AnyJsMemberExpression, T};
    /// use check_js_factory::make;
    ///
...
impl AnyJsOptionalChainExpression {
    ...
    ///
    /// ```
    /// use check_js_syntax::{AnyJsExpression, AnyJsLiteralExpression, AnyJsOptionalChainExpression, T};
    /// use check_js_factory::make;
    ///
...
impl AnyJsObjectMemberName {
    ...
    ///
    /// ```
    /// use check_js_syntax::{AnyJsObjectMemberName, AnyJsExpression, AnyJsLiteralExpression, T};
    /// use check_js_factory::make;
    ///
...
impl AnyTsEnumMemberName {
    ...
    ///
    /// ```
    /// use check_js_syntax::{AnyTsEnumMemberName, AnyJsExpression, AnyJsLiteralExpression, T};
    /// use check_js_factory::make;
    ///
...
impl AnyJsClassMemberName {
    ...
    ///
    /// ```
    /// use check_js_syntax::{AnyJsClassMemberName, AnyJsExpression, AnyJsLiteralExpression, T};
    /// use check_js_factory::make;
    ///
    /// let name = make::js_literal_member_name(make::ident("a"));
...
///
/// ```
/// use check_js_syntax::{AnyJsExpression, AnyJsLiteralExpression, AnyJsMemberExpression, global_identifier, T};
/// use check_js_factory::make;
///
...
#[cfg(test)]
mod test {
    use check_js_factory::syntax::{JsCallExpression, JsTemplateExpression};
    use check_js_parser::JsParserOptions;
    use check_js_parser::parse_module;
