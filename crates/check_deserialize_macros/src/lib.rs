...
/// Derives the [check_deserialize::Deserializable] trait for a custom enum or
/// struct.
///
...
///   and where `T` also implements [check_deserialize::Deserializable]. The
...
/// #[derive(Default, Deserializable)]
/// struct ValidatedStruct {
///     #[deserializable(required, validate = "check_deserialize::non_empty")]
///     non_empty: String,
/// }
/// ```
///
...
/// Derives the [check_deserialize::Merge] trait for a custom enum or
/// struct.
