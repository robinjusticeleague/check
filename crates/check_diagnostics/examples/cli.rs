...
use check_diagnostics::{Advices, Diagnostic, LogCategory, PrintDiagnostic, Resource, Visit};
...
impl Advices for CliAdvices {
    fn record(&self, visitor: &mut dyn Visit) -> io::Result<()> {
        ...
        visitor.record_command("check --help")
    }
}
...
pub fn main() {
    let diag = CliDiagnostic {
        ...
        source_code: String::from("check format file.js"),
        advices: CliAdvices {
            suggested_name: String::from("format"),
            suggested_command: String::from("check format file.js"),
        },
    };
