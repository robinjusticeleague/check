...
impl check_console::fmt::Display for Severity {
    fn fmt(&self, f: &mut check_console::fmt::Formatter<'_>) -> io::Result<()> {
        match self {
...
pub(crate) mod internal {
    ...
    /// functions in `check_diagnostics` to be generic over all diagnostics +
    /// `Error`.
