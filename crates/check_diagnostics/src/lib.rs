...
pub use check_console as console;

// Re-export macros from utility crates
pub use check_diagnostics_categories::{Category, category, category_concat};
pub use check_diagnostics_macros::Diagnostic;
...
pub mod prelude {
    ...
    //! intended to be imported as `use check_diagnostics::prelude::*;` to
