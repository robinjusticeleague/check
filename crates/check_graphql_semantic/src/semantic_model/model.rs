...
impl SemanticModel {
    ...
    /// use check_graphql_syntax::GraphqlNameReference;
    /// use check_graphql_semantic::{semantic_model, BindingExtensions};
    ///
    ...
    /// use check_graphql_parser::parse_graphql;
    /// use check_rowan::{AstNode, SyntaxNodeCast};
    /// use check_graphql_syntax::GraphqlVariableReference;
    /// use check_graphql_semantic::semantic_model;
    ///
