...
use check_js_syntax::{EmbeddingKind, JsFileSource, TextRange, TextSize};
...
fn format(
    ...
    javascript::format(check_path, document_file_source, parse, settings)
}
...
pub(crate) fn format_range(
    ...
    javascript::format_range(check_path, document_file_source, parse, settings, range)
}
...
pub(crate) fn format_on_type(
    ...
    javascript::format_on_type(check_path, document_file_source, parse, settings, offset)
}
