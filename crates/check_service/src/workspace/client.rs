        ...
        let value: InitializeResult = client.request(
            ...
            json!({
                ...
                "clientInfo": {
                    ...
                    "version": check_configuration::VERSION
                },
            }),
        )?;
    ...
    T: WorkspaceTransport + RefUnwindSafe + Send + Sync,
{
    ...
    fn file_features(
        ...
        self.request("check/file_features", params)
    }

    fn is_path_ignored(&self, params: PathIsIgnoredParams) -> Result<bool, WorkspaceError> {
        self.request("check/is_path_ignored", params)
    }
    ...
    fn get_syntax_tree(
        ...
        self.request("check/get_syntax_tree", params)
    }
    ...
    fn get_registered_types(
        ...
        self.request("check/get_registered_types", params)
    }

    fn get_semantic_model(&self, params: GetSemanticModelParams) -> Result<String, WorkspaceError> {
        self.request("check/get_semantic_model", params)
    }

    fn get_file_content(&self, params: GetFileContentParams) -> Result<String, WorkspaceError> {
        self.request("check/get_file_content", params)
    }
    ...
    fn get_module_graph(
        ...
        self.request("check/get_module_graph", params)
    }
}
