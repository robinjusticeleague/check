...
use check_configuration::analyzer::{RuleGroup, RuleSelector};
...
use check_fs::{CheckPath, MemoryFileSystem};
use check_js_syntax::{JsFileSource, TextSize};
...
fn correctly_handle_json_files() {
    ...
    let well_known_json_with_comments_file = FileGuard::open(
        ...
        OpenFileParams {
            project_key,
            path: CheckPath::new(".eslintrc.json"),
            content: FileContent::from_client(r#"{"a": 42}//comment"#),
            document_file_source: None,
            persist_node_cache: false,
        },
    ...
    let well_known_json_with_comments_file = FileGuard::open(
        ...
        OpenFileParams {
            project_key,
            path: CheckPath::new("project/.vscode/settings.json"),
            content: FileContent::from_client(r#"{"a": 42}//comment"#),
            document_file_source: None,
            persist_node_cache: false,
        },
    ...
    let well_known_json_with_comments_file_with_trailing_commas = FileGuard::open(
        ...
        OpenFileParams {
            project_key,
            path: CheckPath::new("dir/.eslintrc.json"),
            content: FileContent::from_client(r#"{"a": 42,}"#),
            document_file_source: None,
            persist_node_cache: false,
        },
    ...
    let well_known_json_with_comments_and_trailing_commas_file = FileGuard::open(
        ...
        OpenFileParams {
            project_key,
            path: CheckPath::new("tsconfig.json"),
            content: FileContent::from_client(r#"{"a": 42,}//comment"#),
            document_file_source: None,
            persist_node_cache: false,
        },
...
fn correctly_parses_graphql_files() {
    ...
    let graphql_file = FileGuard::open(
        ...
        OpenFileParams {
            project_key,
            path: CheckPath::new("file.graphql"),
...
fn files_loaded_by_the_scanner_are_only_unloaded_when_the_project_is_unregistered() {
    ...
    workspace
        .open_file(OpenFileParams {
            project_key,
            path: CheckPath::new("/project/a.ts"),
...
"#;
    ...
    workspace
        .update_settings(UpdateSettingsParams {
            ...
            workspace_directory: Some(CheckPath::new("/project")),
        })
        .unwrap();
...
"#;
    ...
    workspace
        .open_file(OpenFileParams {
            project_key,
            path: CheckPath::new("/project/a.css"),
            content: FileContent::FromServer,
            document_file_source: None,
            persist_node_cache: false,
        })
                ...
                overrides: Some(Overrides(vec![
                    OverridePattern {
                        includes: Some(OverrideGlobs::Globs(Box::new([
                            check_glob::NormalizedGlob::from_str("./lib/**").unwrap(),
                        ]))),
                        plugins: Some(Plugins(vec![PluginConfiguration::Path(
                    ...
                    OverridePattern {
                        includes: Some(OverrideGlobs::Globs(Box::new([
                            check_glob::NormalizedGlob::from_str("./utils/**").unwrap(),
                        ]))),
                        plugins: Some(Plugins(vec![PluginConfiguration::Path(
...
fn debug_module_graph() {
    ...
    workspace
        .open_file(OpenFileParams {
            project_key,
            path: CheckPath::new("/project/file.js"),
            content: FileContent::from_client(
                r#"
...
"#,
    ...
    workspace
        .open_file(OpenFileParams {
            project_key,
            path: CheckPath::new("/project/utils.js"),
...
"#,
    ...
    workspace
        .open_file(OpenFileParams {
            project_key,
            path: CheckPath::new("/project/dynamic.js"),
