...
pub fn format_range(
    ...
    check_formatter::format_range(root, range, CssFormatLanguage::new(options))
}
...
pub fn format_node(
    ...
    check_formatter::format_node(root, CssFormatLanguage::new(options))
}
...
pub fn format_sub_tree(options: CssFormatOptions, root: &CssSyntaxNode) -> FormatResult<Printed> {
    check_formatter::format_sub_tree(root, CssFormatLanguage::new(options))
}
