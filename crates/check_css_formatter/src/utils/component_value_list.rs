...
use crate::prelude::*;
use check_css_syntax::{CssGenericDelimiter, CssGenericProperty, CssLanguage, CssSyntaxKind};
use check_formatter::{CstFormatContext, format_args, write};
use check_formatter::{FormatOptions, FormatResult};
use check_rowan::{AstNode, AstNodeList, TextSize};
...
pub(crate) enum ValueListLayout {
    ...
    /// see https://github.com/checkjs/check/pull/5334 for a detailed explanation
    OneGroupPerLine,
}
