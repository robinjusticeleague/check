...
use check_configuration::{Configuration, CssConfiguration};
use check_css_formatter::{CssFormatLanguage, context::CssFormatOptions};
...
/// `cargo watch -i '*.new' -x 'test -p check_css_formatter formatter'`
///
