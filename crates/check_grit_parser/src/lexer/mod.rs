//! An extremely fast, lookup table based, GritQL lexer which yields SyntaxKind tokens used by the check Grit parser.

#[rustfmt::skip]
mod tests;

use crate::constants::SUPPORTED_LANGUAGE_SET_STR;
use check_grit_syntax::{GritSyntaxKind, GritSyntaxKind::*, T, TextLen, TextRange, TextSize};
use check_parser::diagnostic::ParseDiagnostic;
use check_parser::lexer::{Lexer, LexerCheckpoint};
