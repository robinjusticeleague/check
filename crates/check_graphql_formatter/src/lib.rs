...
use check_formatter::{Formatted, Printed};
use check_graphql_syntax::{GraphqlLanguage, GraphqlSyntaxNode, GraphqlSyntaxToken};
use check_rowan::{AstNode, SyntaxNode, SyntaxToken, TextRange};
...
pub fn format_range(
    ...
    check_formatter::format_range(root, range, GraphqlFormatLanguage::new(options))
}
...
pub fn format_node(
    ...
    check_formatter::format_node(root, GraphqlFormatLanguage::new(options))
}
...
pub fn format_sub_tree(
    ...
    check_formatter::format_sub_tree(root, GraphqlFormatLanguage::new(options))
}
