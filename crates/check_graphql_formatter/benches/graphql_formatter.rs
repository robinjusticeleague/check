...
use check_test_utils::BenchCase;
...
fn bench_formatter(criterion: &mut Criterion) {
    ...
    let mut group = criterion.benchmark_group("graphql_formatter");
...
criterion_group!(graphql_formatter, bench_formatter);
criterion_main!(graphql_formatter);
