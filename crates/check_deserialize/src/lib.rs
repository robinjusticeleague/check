...
//! 0ne of the main difference is the fault-tolerant behavior of `check_deserialize`.
...
//!
//! It currently supports the JSON data format. See [check_deserialize::json] for more details.
//!
...
pub use check_rowan::{Text, TextRange};
pub use diagnostics::{
...
///
/// `check_deserialize` provides [Deserializable] implementations for common Rust types.
...
/// See [check_deserialize::json] for an example of an implementation.
