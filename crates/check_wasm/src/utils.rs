...
use check_console::fmt::HTML;
use check_console::{fmt::Formatter, markup};
use check_diagnostics::serde::Diagnostic;
use check_diagnostics::{DiagnosticExt, LineIndexBuf, PrintDiagnostic, SourceCode};
...
impl DiagnosticPrinter {
    ...
    fn print(
        ...
        printer: fn(&check_diagnostics::Error) -> PrintDiagnostic<check_diagnostics::Error>,
    ) -> Result<(), Error> {
        let diag: Diagnostic =
