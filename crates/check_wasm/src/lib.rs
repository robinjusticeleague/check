...
use check_service::workspace::{OpenFileParams, SupportsFeatureParams};
...
pub struct MemoryFileSystem {
    inner: Arc<check_fs::MemoryFileSystem>,
}
...
impl MemoryFileSystem {
    ...
    fn as_inner(&self) -> Arc<check_fs::MemoryFileSystem> {
...
impl Workspace {
    ...
    pub fn new() -> Self {
        Self {
            inner: workspace::server(Arc::new(check_fs::MemoryFileSystem::default()), None),
        }
    }
