...
pub use check_analyze::ControlFlow;
use check_analyze::{
...
use check_rowan::{BatchMutation, SyntaxToken};
use camino::Utf8Path;
...
mod test {
    ...
    use check_analyze::{AnalysisFilter, ControlFlow, Never};
    ...
    fn quick_test() {
        let source = r#"{
	"$schema": "https://checkjs.dev/schemas/1.0.0/schema.json",
	"javascript": {
		"formatter": {
			"trailingCommas": "all",
			"indentSize": 2
