use check_formatter::{Format, FormatOwnedWithRule, FormatRefWithRule, FormatResult};

use crate::{AsFormat, HtmlFormatContext, HtmlFormatter, IntoFormat};
use check_html_syntax::{HtmlSyntaxNode, map_syntax_node};

#[derive(Debug, Copy, Clone, Default)]
pub struct FormatHtmlSyntaxNode;

impl check_formatter::FormatRule<HtmlSyntaxNode> for FormatHtmlSyntaxNode {
