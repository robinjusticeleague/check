...
use check_formatter::{FormatRuleWithOptions, GroupId, write};
use check_html_syntax::{HtmlOpeningElement, HtmlOpeningElementFields};
...
pub(crate) struct FormatHtmlOpeningElement {
    ...
    /// [HtmlElementList]: check_html_syntax::HtmlElementList
