...
#[test]
fn should_use_editorconfig_enabled_from_check_conf() {
    let fs = MemoryFileSystem::default();
    let mut console = BufferConsole::default();
...
"#,
    ...
    let checkconfig = Utf8Path::new("check.json");
    fs.insert(
        checkconfig.into(),
        r#"{
    "formatter": {
...
"#;
    ...
    assert_cli_snapshot(SnapshotPayload::new(
        module_path!(),
        "should_use_editorconfig_enabled_from_check_conf",
        fs,
        console,
        result,
    ));
...
#[test]
fn should_use_editorconfig_check_enabled_from_check_conf() {
    let fs = MemoryFileSystem::default();
    let mut console = BufferConsole::default();
...
"#;
    ...
    assert_cli_snapshot(SnapshotPayload::new(
        module_path!(),
        "should_use_editorconfig_check_enabled_from_check_conf",
        fs,
        console,
        result,
    ));
...
#[test]
fn should_have_check_override_editorconfig() {
    let fs = MemoryFileSystem::default();
    let mut console = BufferConsole::default();
...
"#,
    ...
    let check_config_path = Utf8Path::new("check.json");
    fs.insert(
        check_config_path.into(),
        r#"
{
    "formatter": {
        "lineWidth": 90
...
"#;
    ...
    assert_cli_snapshot(SnapshotPayload::new(
        module_path!(),
        "should_have_check_override_editorconfig",
        fs,
        console,
        result,
    ));
...
#[test]
fn should_not_use_higher_editorconfig_when_find_check_conf() {
    let fs = MemoryFileSystem::default();
    let mut console = BufferConsole::default();
...
"#,
    ...
    let check_config_path = Utf8Path::new("foo/check.json");
    fs.insert(
        check_config_path.into(),
        r#"
{
...
"#,
    ...
    assert_cli_snapshot(SnapshotPayload::new(
        module_path!(),
        "should_not_use_higher_editorconfig_when_find_check_conf",
        fs,
        console,
        result,
    ));
...
#[test]
fn should_use_editorconfig_ci_enabled_from_check_conf() {
    let fs = MemoryFileSystem::default();
    let mut console = BufferConsole::default();
...
"#;
    ...
    assert_cli_snapshot(SnapshotPayload::new(
        module_path!(),
        "should_use_editorconfig_ci_enabled_from_check_conf",
        fs,
        console,
        result,
    ));
