...
#[test]
fn always_disable_trailing_commas_check_json() {
    let fs = MemoryFileSystem::default();
    let mut console = BufferConsole::default();
...
"#;
    ...
    assert_cli_snapshot(SnapshotPayload::new(
        module_path!(),
        "always_disable_trailing_commas_check_json",
        fs,
        console,
        result,
    ));
