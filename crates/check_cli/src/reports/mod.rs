...
/// Information computed from a [diagnostic][check_diagnostics::Diagnostic]
#[derive(Debug, Serialize)]
pub struct ReportDiagnostic {
    /// Severity of the [diagnostic][check_diagnostics::Diagnostic]
    pub severity: Severity,
    /// The code of the [diagnostic][check_diagnostics::Diagnostic]
    pub code: Option<&'static Category>,
    /// The title of the [diagnostic][check_diagnostics::Diagnostic]
    pub title: String,
}
