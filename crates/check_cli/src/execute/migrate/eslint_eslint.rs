...
///
/// See [super::eslint_to_check] for converting an ESLint config to a Check config.
...
impl check_deserialize::Deserializable for IgnorePattern {
    fn deserialize(
        ctx: &mut impl DeserializationContext,
        value: &impl DeserializableValue,
        name: &str,
    ) -> Option<Self> {
        let s = check_deserialize::Text::deserialize(ctx, value, name)?;
...
impl From<Severity> for check_configuration::RulePlainConfiguration {
        ...
        impl DeserializationVisitor for Visitor {
            ...
            fn visit_map(
                ...
                members: impl Iterator<
                    Item = Option<(
                        impl check_deserialize::DeserializableValue,
                        impl check_deserialize::DeserializableValue,
                    )>,
                >,
                _range: check_rowan::TextRange,
                name: &str,
            ) -> Option<Self::Output> {
                use check_deserialize::Text;
...
impl From<NoConsoleOptions> for check_rule_options::no_console::NoConsoleOptions {
