...
use check_configuration::analyzer::LinterEnabled;
use check_configuration::analyzer::assist::{AssistConfiguration, AssistEnabled};
use check_configuration::formatter::FormatterEnabled;
use check_configuration::{Configuration, FormatterConfiguration, LinterConfiguration};
use check_console::Console;
use check_deserialize::Merge;
use check_fs::FileSystem;
use check_service::{Workspace, WorkspaceError, configuration::LoadedConfiguration};
...
impl CommandRunner for CheckCommandPayload {
    ...
    fn merge_configuration(
        ...
        let mut configuration =
            self.combine_configuration(directory_path, check_configuration, fs)?;
