...
impl Diagnostic for ExceededTypesLimitDiagnostic {
    ...
    fn message(&self, fmt: &mut Formatter<'_>) -> std::io::Result<()> {
        ...
        fmt.write_markup(markup! {
            "Check encountered an unusually large amount of types which exceeded the limit of "{num}"."
        })?;
        ...
        analyzing large files and what to do about them in "<Hyperlink href={"https://checkjs.dev/guides/investigate-slowness/"}>"the relative guide."</Hyperlink>
        })?;
    ...
    fn advices(&self, visitor: &mut dyn Visit) -> std::io::Result<()> {
        ...
        visitor.record_log(LogCategory::Info, &markup!{
            "Refer to the "<Hyperlink href={"https://checkjs.dev/reference/configuration/#filesexperimentalscannerignores"}>"documentation"</Hyperlink>" for more information."
        })?;
