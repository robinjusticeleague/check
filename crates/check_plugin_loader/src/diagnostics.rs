...
use check_diagnostics::{Diagnostic, Error, MessageAndDescription};
use check_fs::FileSystemDiagnostic;
use check_grit_patterns::CompileError;
use check_resolver::{ResolveError, ResolveErrorDiagnostic};
use check_rowan::SyntaxError;
...
impl From<PluginDiagnostic> for check_diagnostics::serde::Diagnostic {
