use check_analyze::AnalyzerPluginVec;
use check_configuration::plugins::{PluginConfiguration, Plugins};
use camino::Utf8PathBuf;
use papaya::HashMap;
use rustc_hash::{FxBuildHasher, FxHashSet};

use crate::{CheckPlugin, PluginDiagnostic};
...
pub struct PluginCache(HashMap<Utf8PathBuf, CheckPlugin, FxBuildHasher>);

impl PluginCache {
    /// Inserts a new plugin into the cache.
    pub fn insert_plugin(&self, path: Utf8PathBuf, plugin: CheckPlugin) {
