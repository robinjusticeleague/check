...
use check_grit_syntax::{GritLanguage, GritSyntaxNode};
...
pub fn format_node(
    ...
    check_formatter::format_node(root, GritFormatLanguage::new(options))
}
...
pub fn format_range(
    ...
    check_formatter::format_range(root, range, GritFormatLanguage::new(options))
}
...
pub fn format_sub_tree(options: GritFormatOptions, root: &GritSyntaxNode) -> FormatResult<Printed> {
    check_formatter::format_sub_tree(root, GritFormatLanguage::new(options))
}
...
impl FormatLanguage for GritFormatLanguage {
    ...
    fn transform(
        &self,
        _root: &check_rowan::SyntaxNode<Self::SyntaxLanguage>,
    ) -> Option<(
        check_rowan::SyntaxNode<Self::SyntaxLanguage>,
        check_formatter::TransformSourceMap,
    )> {
        None
    }
    ...
    fn is_range_formatting_node(
        &self,
        _node: &check_rowan::SyntaxNode<Self::SyntaxLanguage>,
    ) -> bool {
        true
    }

    fn options(&self) -> &<Self::Context as check_formatter::FormatContext>::Options {
        &self.options
    }

    fn create_context(
        self,
        root: &check_rowan::SyntaxNode<Self::SyntaxLanguage>,
        source_map: Option<check_formatter::TransformSourceMap>,
    ) -> Self::Context {
