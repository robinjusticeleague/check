...
use check_formatter::printer::PrinterOptions;
use check_formatter::{
...
impl CstFormatContext for GritFormatContext {
    ...
    fn comments(&self) -> &check_formatter::comments::Comments<Self::Language> {
        &self.comments
    }
}
...
impl FormatOptions for GritFormatOptions {
    ...
    fn as_print_options(&self) -> check_formatter::prelude::PrinterOptions {
