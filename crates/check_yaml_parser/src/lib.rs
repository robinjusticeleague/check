use check_parser::{AnyParse, prelude::ParseDiagnostic, tree_sink::LosslessTreeSink};
use check_rowan::{AstNode, NodeCache};
use check_yaml_factory::YamlSyntaxFactory;
use check_yaml_syntax::{YamlLanguage, YamlRoot, YamlSyntaxNode};
...
impl YamlParse {
    ...
    ///
    /// ```
    /// # use check_yaml_parser::parse_yaml;
    /// # use check_yaml_syntax::YamlSyntaxKind;
