...
pub struct Actions {
    #[doc = r" It enables the assist actions recommended by Check. `true` by default."]
...
pub struct Source {
    ...
    pub organize_imports: Option<
        RuleAssistConfiguration<check_rule_options::organize_imports::OrganizeImportsOptions>,
    >,
    #[doc = "Enforce attribute sorting in JSX elements."]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub use_sorted_attributes: Option<
        RuleAssistConfiguration<
            check_rule_options::use_sorted_attributes::UseSortedAttributesOptions,
        >,
    >,
    #[doc = "Sort the keys of a JSON object in natural order."]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub use_sorted_keys:
        Option<RuleAssistConfiguration<check_rule_options::use_sorted_keys::UseSortedKeysOptions>>,
    #[doc = "Enforce ordering of CSS properties and nested rules."]
    #[serde(skip_serializing_if = "Option::is_none")]
    pub use_sorted_properties: Option<
        RuleAssistConfiguration<
            check_rule_options::use_sorted_properties::UseSortedPropertiesOptions,
        >,
    >,
}
impl Source {
