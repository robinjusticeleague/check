...
pub fn ensure_cache_dir() -> Utf8PathBuf {
    let path = if let Some(proj_dirs) = ProjectDirs::from("dev", "checkjs", "check") {
        // Linux: /home/alice/.cache/check
        // Win: C:\Users\Alice\AppData\Local\checkjs\check\cache
        // Mac: /Users/Alice/Library/Caches/dev.checkjs.check
