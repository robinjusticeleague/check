...
//! Both rome_grit_lexer and check_grit_parser rely on these definitions, therefore
...
use check_rowan::{AstNode, RawSyntaxKind, SyntaxKind};

pub use check_rowan::{TextLen, TextRange, TextSize, TokenAtOffset, TriviaPieceKind, WalkEvent};
...
impl check_rowan::SyntaxKind for GraphqlSyntaxKind {
