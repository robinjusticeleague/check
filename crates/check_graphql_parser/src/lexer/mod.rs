//! An extremely fast, lookup table based, GraphQL lexer which yields SyntaxKind tokens used by the check GraphQL parser.
#[rustfmt::skip]
mod tests;

use check_graphql_syntax::{GraphqlSyntaxKind, GraphqlSyntaxKind::*, T, TextLen, TextSize};
use check_parser::diagnostic::ParseDiagnostic;
use check_parser::lexer::{Lexer, LexerCheckpoint, LexerWithCheckpoint, TokenFlags};
