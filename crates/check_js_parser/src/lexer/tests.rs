...
use crate::span::Span;
use check_js_syntax::JsSyntaxKind::{self, EOF, ERROR_TOKEN};
use check_js_syntax::JsSyntaxKind::{JS_NUMBER_LITERAL, NEWLINE, WHITESPACE};
use check_js_syntax::T;
use check_parser::lexer::{BufferedLexer, Lexer, ReLexer};
...
macro_rules! assert_lex {
    ($src:expr, $($kind:ident:$len:expr $(,)?)*) => {{
        ...
        $(
            assert_eq!(
                tokens[idx].0,
                check_js_syntax::JsSyntaxKind::$kind,
