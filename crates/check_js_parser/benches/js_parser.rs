use check_diagnostics::{DiagnosticExt, print_diagnostic_to_string};
        ...
        match test_case {
            Ok(test_case) => {
                ...
                group.bench_with_input(
                    ...
                    |b, _| {
                        b.iter(|| {
                            let result = black_box(check_js_parser::parse(
                                code,
                                file_source,
                    ...
                    |b, _| {
                        b.iter_batched(
                            || {
                                ...
                                check_js_parser::parse_js_with_cache(
                                    code,
                                    file_source,
                                    JsParserOptions::default(),
                                    &mut cache,
                            ...
                            |mut cache| {
                                black_box(check_js_parser::parse_js_with_cache(
                                    code,
                                    file_source,
                                    JsParserOptions::default(),
                                    &mut cache,
