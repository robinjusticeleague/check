use crate::prelude::*;
use check_formatter::FormatError::SyntaxError;
use check_formatter::{FormatRuleWithOptions, GroupId, format_args, write};
use check_js_syntax::{TsTypeParameters, TsTypeParametersFields};
