use crate::prelude::*;
use check_formatter::{FormatOwnedWithRule, FormatRefWithRule};

use crate::{AsFormat, IntoFormat, JsFormatContext};
use check_js_syntax::{JsSyntaxNode, map_syntax_node};

#[derive(Debug, Copy, Clone, Default)]
pub struct FormatJsSyntaxNode;

impl check_formatter::FormatRule<JsSyntaxNode> for FormatJsSyntaxNode {
