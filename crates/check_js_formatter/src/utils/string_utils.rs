...
use crate::prelude::*;
use check_formatter::QuoteStyle;
use check_formatter::token::string::normalize_string;
use check_js_syntax::JsSyntaxKind::{JS_STRING_LITERAL, JSX_STRING_LITERAL};
use check_js_syntax::{JsFileSource, JsSyntaxToken};
use check_unicode_table::is_js_ident;
use std::borrow::Cow;
...
/// Convenience enum to map [check_js_syntax::JsFileSource] by just reading
/// the type of file
#[derive(Eq, PartialEq)]
...
mod tests {
    ...
    use check_js_syntax::JsSyntaxKind::{JS_STRING_LITERAL, JS_STRING_LITERAL_EXPRESSION};
    use check_js_syntax::{JsStringLiteralExpression, JsSyntaxToken};
