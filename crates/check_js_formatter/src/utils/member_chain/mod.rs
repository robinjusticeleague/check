...
//! ```
//!
//! When we track the first [check_js_syntax::JsCallExpression], we hold basically all the children,
...
//!
//! 1. as many as [check_js_syntax::JsCallExpression] we can find, this cover cases like `something()()().then()`;
//! 2. as many as [check_js_syntax::JsComputedMemberExpression] we can find, this cover cases like `something()()[1][3].then()`;
//! 3. as many as consecutive [check_js_syntax::JsStaticMemberExpression] or [check_js_syntax::JsComputedMemberExpression], this cover cases like `this.items[0].then()`
//!
...
use check_formatter::{Buffer, write};
use check_js_syntax::{
...
use check_rowan::{AstNode, SyntaxResult};
