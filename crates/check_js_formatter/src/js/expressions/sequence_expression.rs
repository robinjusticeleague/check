...
use check_js_syntax::JsSyntaxKind::JS_SEQUENCE_EXPRESSION;
use check_js_syntax::parentheses::NeedsParentheses;
use check_js_syntax::{JsSequenceExpression, JsSequenceExpressionFields, JsSyntaxKind};
...
mod tests {
    ...
    use check_js_syntax::JsSequenceExpression;
