...
use check_formatter::{VecBuffer, format_args, format_element, write};
use check_js_syntax::{
...
use check_rowan::{AstSeparatedElement, AstSeparatedList, SyntaxResult};
...
fn write_grouped_arguments(
    ...
    // We now cache them the delimiters tokens. This is needed because `[check_formatter::best_fitting]` will try to
