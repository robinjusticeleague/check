...
use check_js_syntax::{AnyJsComputedMember, JsAwaitExpression};
use check_js_syntax::{JsAwaitExpressionFields, JsSyntaxKind};
...
mod tests {
    ...
    use check_js_syntax::JsAwaitExpression;
