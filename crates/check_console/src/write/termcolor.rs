...
mod tests {
    ...
    use check_markup::markup;
    use termcolor::Ansi;

    use crate as check_console;
    ...
    #[test]
    fn test_hyperlink() {
        const OUTPUT: &str = "\x1b[0m\x1b]8;;https://checkjs.dev/\x1b\\link\x1b]8;;\x1b\\\x1b[0m";
        ...
        formatter
            .write_markup(markup! {
                <Hyperlink href="https://checkjs.dev/">"link"</Hyperlink>
            })
            .unwrap();
