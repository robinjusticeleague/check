use check_package::{NodeJsPackage, Package, PackageJson, TsConfigJson};
use check_rowan::SendNode;
...
/// settings.
///
/// For Check, a project is where the **top-level** configuration file is, while
...
///
/// Because Check is intended to support multiple kinds of JavaScript projects,
/// the term "package" is somewhat loosely defined. It may be an NPM package,
/// a JSR package, or simply a directory with its own nested `check.json`.
#[derive(Debug, Default)]
