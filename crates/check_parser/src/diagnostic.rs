...
use check_diagnostics::console::fmt::Display;
use check_diagnostics::console::{MarkupBuf, markup};
use check_diagnostics::location::AsSpan;
use check_diagnostics::{Advices, Diagnostic, Location, LogCategory, MessageAndDescription, Visit};
use check_rowan::{SyntaxKind, TextLen, TextRange};
...
impl ParseDiagnostic {
    ...
    /// # use check_diagnostics::{DiagnosticExt, PrintDiagnostic, console::fmt::Formatter};
    /// # use check_parser::diagnostic::ParseDiagnostic;
    /// # use check_rowan::{TextSize, TextRange};
    /// # use std::fmt::Write;
    ///
    /// let source = "const a";
    ...
    ///
    /// let mut write = check_diagnostics::termcolor::Buffer::no_color();
