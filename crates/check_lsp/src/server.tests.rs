...
use check_analyze::RuleCategories;
use check_configuration::analyzer::RuleSelector;
use check_diagnostics::PrintDescription;
use check_fs::{CheckPath, MemoryFileSystem, TemporaryFs};
use check_service::Watcher;
...
impl Server {
    ...
    /// Basic implementation of the `check/shutdown` request for tests
    async fn check_shutdown(&mut self) -> Result<()> {
        self.request::<_, ()>("check/shutdown", "_check_shutdown", ())
            .await?
            .context("check/shutdown returned None")?;
        Ok(())
    }
}
...
async fn document_lifecycle() -> Result<()> {
    ...
    let res: GetSyntaxTreeResult = server
        .request(
            "check/get_syntax_tree",
            "get_syntax_tree",
            GetSyntaxTreeParams {
                project_key,
                path: CheckPath::try_from(uri!("document.js").to_file_path().unwrap()).unwrap(),
            },
        )
        .await?
                ...
                diagnostics: vec![
                    lsp::Diagnostic {
                        ...
                        code_description: Some(lsp::CodeDescription {
                            href: "https://checkjs.dev/linter/rules/no-unused-variables"
                                .parse()
                                .unwrap(),
                        }),
                        source: Some(String::from("check")),
                    ...
                    lsp::Diagnostic {
                        ...
                        code_description: Some(CodeDescription {
                            href: "https://checkjs.dev/linter/rules/no-const-assign".parse()?
                        }),
                        source: Some(String::from("check")),
            ...
            PublishDiagnosticsParams {
                ...
                diagnostics: vec![
                    ...
                    lsp::Diagnostic {
                        ...
                        code_description: Some(lsp::CodeDescription {
                            href:
                                "https://checkjs.dev/linter/rules/no-unused-private-class-members"
                                    .parse()
                                    .unwrap(),
                        }),
                        source: Some(String::from("check")),
...
async fn pull_quick_fixes() -> Result<()> {
    ...
    let expected_code_action = CodeActionOrCommand::CodeAction(CodeAction {
        ...
        kind: Some(CodeActionKind::new(
            "quickfix.check.suspicious.noCompareNegZero",
        )),
    ...
    suppression_changes.insert(
        ...
        vec![TextEdit {
            ...
            new_text: String::from(
                "// check-ignore lint/suspicious/noCompareNegZero: <explanation>\n",
            ),
        }],
    );
    ...
    let expected_inline_suppression_action = CodeActionOrCommand::CodeAction(CodeAction {
        ...
        kind: Some(CodeActionKind::new("quickfix.suppressRule.inline.check")),
        diagnostics: Some(vec![fixable_diagnostic(0)?]),
        edit: Some(WorkspaceEdit {
    ...
    top_level_changes.insert(
        ...
        vec![TextEdit {
            ...
            new_text: String::from(
                "/** check-ignore-all lint/suspicious/noCompareNegZero: <explanation> */\n",
            ),
        }],
    );
    ...
    let expected_top_level_suppression_action = CodeActionOrCommand::CodeAction(CodeAction {
        ...
        kind: Some(CodeActionKind::new("quickfix.suppressRule.topLevel.check")),
        diagnostics: Some(vec![fixable_diagnostic(0)?]),
        edit: Some(WorkspaceEdit {
...
#[tokio::test]
async fn pull_check_quick_fixes() -> Result<()> {
    let factory = ServerFactory::default();
    let (service, client) = factory.create().into_inner();
    let (stream, sink) = client.split();
    let mut server = Server::new(service);
...
async fn pull_quick_fixes_include_unsafe() -> Result<()> {
    ...
    top_level_changes.insert(
        ...
        vec![TextEdit {
            ...
            new_text: String::from(
                "/** check-ignore-all lint/suspicious/noDoubleEquals: <explanation> */\n",
            ),
        }],
    );
    ...
    let unsafe_action = CodeActionOrCommand::CodeAction(CodeAction {
        ...
        kind: Some(CodeActionKind::new(
            "quickfix.check.suspicious.noDoubleEquals",
        )),
...
async fn pull_diagnostics_for_rome_json() -> Result<()> {
    ...
    server
        .open_named_document(incorrect_config, uri!("check.json"), "json")
        .await?;
...
async fn plugin_load_error_show_message() -> Result<()> {
    ...
    fs.insert(to_utf8_file_path_buf(uri!("check.json")), config);
    fs.insert(
    ...
    assert_eq!(notification, Some(ServerNotification::ShowMessage(ShowMessageParams {
        ...
        message: "The plugin loading has failed. Check will report only parsing errors until the file is fixed or its usage is disabled.".to_string(),
    })));
        ...
        Some(ServerNotification::PublishDiagnostics(
            PublishDiagnosticsParams {
                ...
                diagnostics: vec![Diagnostic {
                    ...
                    code_description: Some(CodeDescription {
                        href: "https://checkjs.dev/linter/rules/no-unknown-property".parse()?
                    }),
                    source: Some(String::from("check")),
...
"#,
    ...
    let expected_code_action = CodeActionOrCommand::CodeAction(CodeAction {
        title: String::from("Organize Imports (Check)"),
        kind: Some(CodeActionKind::new("source.organizeImports.check")),
        diagnostics: None,
        edit: Some(WorkspaceEdit {
            changes: Some(changes),
            document_changes: None,
    ...
    top_level_changes.insert(
        ...
        vec![TextEdit {
            ...
            new_text: String::from(
                "/** check-ignore-all assist/source/organizeImports: <explanation> */\n",
            ),
        }],
    );
    ...
    inline_changes.insert(
        ...
        vec![TextEdit {
            ...
            new_text: String::from(
                "// check-ignore assist/source/organizeImports: <explanation>\n",
            ),
        }],
    );
...
async fn does_not_pull_action_for_disabled_rule_in_override_issue_2782() -> Result<()> {
    let fs = MemoryFileSystem::default();
    let config = r#"{
    "$schema": "https://checkjs.dev/schemas/1.7.3/schema.json",
    ...
    server.initialized().await?;
    server
        .open_named_document(config, uri!("check.json"), "json")
        .await?;
    server
        .open_named_document(
            r#"enum X {
        ...
        .request(
            ...
            CodeActionParams {
                ...
                context: CodeActionContext {
                    diagnostics: vec![fixable_diagnostic(0)?],
                    only: Some(vec![CodeActionKind::new(
                        "quickfix.check.style.useEnumInitializers",
                    )]),
                    ..Default::default()
                },
                work_done_progress_params: WorkDoneProgressParams {
...
async fn pull_refactors() -> Result<()> {
    ...
    let _expected_action = CodeActionOrCommand::CodeAction(CodeAction {
        ...
        kind: Some(CodeActionKind::new("refactor.inline.check")),
        diagnostics: None,
        edit: Some(WorkspaceEdit {
            changes: Some(changes),
            document_changes: None,
...
async fn pull_fix_all() -> Result<()> {
    ...
    let expected_action = CodeActionOrCommand::CodeAction(CodeAction {
        title: String::from("Apply all safe fixes (Check)"),
        kind: Some(CodeActionKind::new("source.fixAll.check")),
        ...
        Some(ServerNotification::PublishDiagnostics(
            PublishDiagnosticsParams {
                ...
                diagnostics: vec![Diagnostic {
                    ...
                    code_description: Some(CodeDescription {
                        href: "https://checkjs.dev/linter/rules/no-double-equals".parse()?
                    }),
                    source: Some(String::from("check")),
                    message: String::from(
...
async fn multiple_projects() -> Result<()> {
    ...
    server
        .open_named_document(config_only_formatter, uri!("test_one/check.json"), "json")
        .await?;
    ...
    server
        .open_named_document(config_only_linter, uri!("test_two/check.json"), "json")
        .await?;
...
async fn pull_source_assist_action() -> Result<()> {
    ...
    let res: CodeActionResponse = server
        .request(
            ...
            CodeActionParams {
                ...
                context: CodeActionContext {
                    diagnostics: vec![unsafe_fixable.clone()],
                    only: Some(vec![CodeActionKind::new("source.check.useSortedKeys")]),
                    ..Default::default()
                },
                work_done_progress_params: WorkDoneProgressParams {
                    work_done_token: None,
    ...
    let expected_action = CodeActionOrCommand::CodeAction(CodeAction {
        ...
        kind: Some(CodeActionKind::new("source.check.useSortedKeys")),
        diagnostics: None,
        edit: Some(WorkspaceEdit {
            changes: Some(changes),
            document_changes: None,
...
async fn pull_diagnostics_monorepo() -> Result<()> {
    ...
    fs.insert(
        to_utf8_file_path_buf(uri!("check.json")),
        r#"{
  "root": true,
  "linter": {
    "enabled": false
...
"#,
    ...
    fs.insert(
        to_utf8_file_path_buf(uri!("packages/lib/check.json")),
        r#"{
  "linter": {
    "enabled": true
  }
    ...
    let res: CodeActionResponse = server
        .request(
            ...
            CodeActionParams {
                ...
                context: CodeActionContext {
                    diagnostics: vec![],
                    only: Some(vec![CodeActionKind::new("source.fixAll.check")]),
                    ..Default::default()
                },
                work_done_progress_params: WorkDoneProgressParams {
                    work_done_token: None,
