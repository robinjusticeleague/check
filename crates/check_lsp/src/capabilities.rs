use check_analyze::{SUPPRESSION_INLINE_ACTION_CATEGORY, SUPPRESSION_TOP_LEVEL_ACTION_CATEGORY};
...
pub(crate) const DEFAULT_CODE_ACTION_CAPABILITIES: &[&str] = &[
    ...
    // import sorting
    "source.organizeImports.check",
    // fix all
    "source.fixAll.check",
    // general refactors
    "refactor.check",
    "refactor.extract.check",
    "refactor.inline.check",
    "refactor.rewrite.check",
    // source actions
    "source.check",
];
