...
impl<L: Language> SyntaxTriviaPiece<L> {
    ...
    ///
    /// ```
    /// use check_rowan::raw_language::{RawLanguage, RawLanguageKind, RawSyntaxTreeBuilder};
    /// use check_rowan::*;
...
///
/// ```
/// use check_rowan::raw_language::{RawLanguage, RawLanguageKind};
/// use check_rowan::{trim_leading_trivia_pieces, RawSyntaxToken, SyntaxToken, TriviaPiece};
///
...
/// ```
/// use check_rowan::raw_language::{RawLanguage, RawLanguageKind};
/// use check_rowan::{trim_trailing_trivia_pieces, RawSyntaxToken, SyntaxToken, TriviaPiece};
///
/// let token = SyntaxToken::<RawLanguage>::new_detached(
///     RawLanguageKind::LET_TOKEN,
///     "\t/*c*/\n\t let ",
...
/// ```
/// use check_rowan::raw_language::{RawLanguage, RawLanguageKind, RawSyntaxTreeBuilder};
/// use check_rowan::{chain_trivia_pieces, RawSyntaxToken, SyntaxToken, TriviaPiece, TriviaPieceKind};
///
